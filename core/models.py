...
class StudentEnrollment(models.Model):
    ...
    def save(self, *args, **kwargs):
        if not self.roll_no or StudentEnrollment.objects.filter(
            ...
            self.roll_no = (last_roll.roll_no + 1) if last_roll else 1
...
class FeePayment(models.Model):
    ...
    class Meta:
        ...
        constraints = [models.UniqueConstraint(fields=['receipt_no', 'fee_structure', 'payment_mode'],name='unique_payment_per_receipt')]
...
class Scholarship(models.Model):
    ...
    def __str__(self):
        return self.name
class ScholarshipPosting(models.Model):
    ...
    def __str__(self):
        return f"{self.student.student_name} - {self.scholarship.name}"